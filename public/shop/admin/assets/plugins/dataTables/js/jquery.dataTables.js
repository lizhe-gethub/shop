...
(/** @lends <global> */function( $ ) {
	 ...
	 * [DataTables.net](href="http://class *  @param {object} [init={}] configuration object for datatables. options *    are defined by {@link datatable.defaults} *  @requires jquery 1.7+ * *  @example *    // Basic initialisation *    $(document).ready( function { *      $('#example').dataTable(); *    } ); * *  @example *    // Initialisation with configuration options - in this case, disable *    // pagination and sorting. *    $(document).ready( function { *      $('#example').dataTable( { *"paginate": false,
	 *        "sort": false
	 *      } );
	 *    } );
	 */
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var jqFilter = $('input[type="search"]', filter)
			...
			.bind(
				'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/keyup.DT search.DT input.DT paste.DT cut.DT',
				_fnDataSource( settings ) === 'ssp' ?
					_fnThrottle( searchFn, 400 ):
					searchFn
			)
			.bind( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/keypress.DT', function(e) {
		...
		$(settings.nTable).on( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/filter.DT', function () {
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		select
			...
			.bind( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/change.DT', function(e) {
	...
	{
		$(n)
			.bind( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/click.DT', oData, function (e) {
					n.blur(); // Remove focus outline for mouse users
					fn(e);
				} )
			.bind( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/keypress.DT', oData, function (e){
				if ( e.which === 13 ) {
					fn(e);
				} } )
			.bind( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/selectstart.DT', function () {
	...
	DataTable.defaults = {
		 ...
		 *   $('#example').dataTable( {
		 *     "ajax": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/data.json"
		 *   } );
		 *
		 * @example
		 ...
		 *   $('#example').dataTable( {
		 *     "ajax": {
		 *       "url": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/data.json",
		 *       "dataSrc": "tableData"
		 *     }
		 *   } );
		 *
		 ...
		 *           json[i][0] = '<a href="http://authenticgoods.co/message/'+json[i][0]+'>View message</a>'; *         } *         return json; *       } *     } *   } ); * * @example *   // Add data to the request *   $('#example').dataTable( { *"ajax": {
		 *       "url": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/data.json",
		 *       "data": function ( d ) {
		 *         return {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajax": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/sources/arrays.txt",
		 *        "deferRender": true
		 *      } );
		 *    } );
		 */
		 ...
		 *      $('#example').dataTable( {
		 *        "serverSide": true,
		 *        "ajax": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/xhr.php"
		 *      } );
		 *    } );
		 */
		"bServerSide": false,
		 ...
		 *      $('#example').dataTable( {
		 *        "serverSide": true,
		 *        "ajax": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/scripts/server_processing.php",
		 *        "deferLoading": 57
		 *      } );
		 *    } );
		 *
	...
	DataTable.defaults.column = {
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajaxSource": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/sources/objects.txt",
		 *        "columns": [
		 *          { "data": "engine" },
		 *          { "data": "browser" },
		 *          { "data": "platform" },
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "ajaxSource": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/sources/deep.txt",
		 *        "columns": [
		 *          { "data": "engine" },
		 *          { "data": "browser" },
		 *          { "data": "platform.inner" },
		 ...
		 *          {
		 *            "data": "platform",
		 *            "render": "http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/[, ].name"
		 *          }
		 *        ]
		 *      } );
		 *    } );
	...
	$.extend( true, DataTable.ext.renderer, {
		header: {
			_: function ( settings, cell, column, classes ) {
				...
				$(settings.nTable).on( 'http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/order.dt', function ( e, settings, sorting, columns ) {
	 ...
	 *     $('#table').dataTable().on('http://authenticgoods.co/wrapbootstrap/themes/spacelab/assets/plugins/dataTables/js/xhr.dt', function (e, settings, json) {
