...
}var r=[];o:for(var i=0,n=arr.length;i<n;i++){for(var x=0,y=r.length;x<y;
...
}else{if(property=="class"||property=="className"){this.className=String(property)
...
},getOffsets:function(){return $D.getOffsets(this.node)},setPosition:function(pos){var obj={left:String(parseInt(pos.left)-(parseInt(this.getComputedStyle("margin-left"))||0))+"px",top:String(parseInt(pos.top)-(parseInt(this.getComputedStyle("margin-top"))||0))+"px"};
...
var Action=function(fn){this.handler=fn};arale.augment(Action,{fire:function(e){if(e&&e.originalEvent&&e.originalEvent.cancelBubble){
