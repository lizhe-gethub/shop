                ...
                <div class="product product-details clearfix">
                    <div class="col-md-6">
                        <div id="product-main-view">
                            ...
                            {{--<div class="product-view">
                                <img src="/shop/home/shou/img/main-product02.jpg" alt="">
                            </div>
                            <div class="product-view">
                                <img src="/shop/home/shou/img/main-product03.jpg" alt="">
                            </div>
                            <div class="product-view">
                                <img src="/shop/home/shou/img/main-product04.jpg" alt="">
                            </div>--}}
                        </div>
                        <div id="product-view">
                            <div class="product-view">
                            ...
                            {{--<div class="product-view">
                                <img src="/shop/home/shou/img/thumb-product02.jpg" alt="">
                            </div>
                            <div class="product-view">
                                <img src="/shop/home/shou/img/thumb-product03.jpg" alt="">
                            </div>
                            <div class="product-view">
                                <img src="/shop/home/shou/img/thumb-product04.jpg" alt="">
                            </div>--}}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="product-body">
                            ...
                            <h3 class="product-price">${{$info['price']}}
                                <del class="product-old-price">${{$info['price']}}</del>
                            </h3>
                            <div>
                            ...
                            <p><strong>库存:</strong> {{$info['num']}}</p>
                            <p><strong>品牌:</strong></p>
                            <p></p>
                            <div class="product-options">
                                <ul class="size-option">
                                    <li><span class="text-uppercase">尺寸:</span></li>
                            ...
                            <form action="/homecart" method="post">
                                ...
                                <div class="product-btns">
                                    <div class="qty-input">
                                        <span class="text-uppercase">购买数量: </span>
                                        <input class="input" name="num" value="1" type="number" min="1">
                                        <input type="hidden" name="id" value="{{$info['id']}}">
                                    </div>
                                    <button type="submit" class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> 加入购物车
                                    </button>
                    ...
                    <div class="col-md-12">
                        <div class="product-tab">
                            <ul class="tab-nav">
                                ...
                                <li><a data-toggle="tab" href="#tab1">细节</a></li>
                                <li><a data-toggle="tab" href="#tab2">评论 (3)</a></li>
                            </ul>
