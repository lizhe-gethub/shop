                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 hidden-sm hidden-xs">
                                        <a class="banner banner-2" href="#">
                                            <img src="/shop/home/shou/img/banner04.jpg" alt="">
                    ...
                    <div class="store-filter clearfix">
                        <div class="pull-left">
                            ...
                            <div class="sort-filter">
                                <span class="text-uppercase">排序方式:</span>
                                <select class="input">
                        ...
                        <div class="pull-right">
                            <div class="page-filter">
                                <span class="text-uppercase">展示:</span>
                                <select class="input">
                            ...
                            <ul class="store-pages">
                                <li><span class="text-uppercase">页数:</span></li>
                            ...
                            <div class="col-md-4 col-sm-6 col-xs-6">
                                <div class="product product-single">
                                    <div class="product-thumb">
                                        ...
                                        <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> 快速查看</button>
                                        <img src="{{$v->pic}}" alt="">
                                    </div>
                                    <div class="product-body">
                                        <h3 class="product-price">{{$v->price}} <del class="product-old-price">{{$v->price}}</del></h3>
                                        <div class="product-rating">
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                            <i class="fa fa-star"></i>
                                        ...
                                        <h2 class="product-name"><a href="#">{{$v->name}}</a></h2>
